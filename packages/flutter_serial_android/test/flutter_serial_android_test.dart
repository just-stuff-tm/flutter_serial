...
void main() {
  final FlutterSerialAndroidPlatform initialPlatform =
      FlutterSerialAndroidPlatform.instance;
  ...
  test('getPlatformVersion', () async {
    ...
    MockFlutterSerialAndroidPlatform fakePlatform =
        MockFlutterSerialAndroidPlatform();
